    ...
    extends SequentialSolver
{
    ...
    public ForkJoinSolver(Maze maze, int forkAfter, int start, ConcurrentSkipListSet<Integer> visited, HashMap<Integer, Integer> predecessor, AtomicBoolean heartFound)
    {
        this(maze);
        this.forkAfter = forkAfter;
    ...
    private List<Integer> parallelSearch()
    {
        ...
        ForkJoinSolver fork1;
        ForkJoinSolver fork2;
        ForkJoinSolver fork3;
        ForkJoinSolver fork4;
...
//            	}
    	...
    	List<Integer> result1 = fork1.join();
    	List<Integer> result2 = fork2.join();
    	List<Integer> result3 = fork3.join();
    	List<Integer> result4 = fork4.join();
